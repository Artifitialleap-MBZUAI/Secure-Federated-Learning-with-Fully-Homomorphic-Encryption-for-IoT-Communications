...
def Server_get_averaged_weights(matrix_dict, number_of_samples):
    ...
    with torch.no_grad():
        for i in range(number_of_samples):
            ...
            fc1_mean_weight += matrix_dict['user_'+str(i)].fc1_enc
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc1_enc)

            fc2_mean_weight += matrix_dict['user_'+str(i)].fc2_enc
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc2_enc)

            fc3_mean_weight += matrix_dict['user_'+str(i)].fc3_enc 
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc3_enc)  

            fc1_mean_bias += matrix_dict['user_'+str(i)].fc1_enc_B1 
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc1_enc_B1)

            fc2_mean_bias += matrix_dict['user_'+str(i)].fc2_enc_B2
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc2_enc_B2)
 
            fc3_mean_bias += matrix_dict['user_'+str(i)].fc3_enc_B3
            total_size_Enc_W_B += sys.getsizeof(matrix_dict['user_'+str(i)].fc3_enc_B3) 
    ...
    return fc1_mean_weight1, fc1_mean_bias, fc2_mean_weight2, fc2_mean_bias, fc3_mean_weight3, fc3_mean_bias, total_size_Enc_W_B
...
def send_Enc_model_to_Batching_Matrix_updates(matrix_dict, encrypted_model_dict, number_of_samples):
    with torch.no_grad():
      for i in range(number_of_samples):
          #user_id = groups[i][j]
          #print(i,"-->", j,"==>" )
          matrix_dict["user_"+str(i)].fc1_enc = encrypted_model_dict[name_of_enc_models[i]].fc1_enc
          matrix_dict["user_"+str(i)].fc2_enc = encrypted_model_dict[name_of_enc_models[i]].fc2_enc
          matrix_dict["user_"+str(i)].fc3_enc = encrypted_model_dict[name_of_enc_models[i]].fc3_enc

          matrix_dict["user_"+str(i)].fc1_enc_B1 = encrypted_model_dict[name_of_enc_models[i]].fc1_enc_B1
          matrix_dict["user_"+str(i)].fc2_enc_B2 = encrypted_model_dict[name_of_enc_models[i]].fc2_enc_B2
          matrix_dict["user_"+str(i)].fc3_enc_B3 = encrypted_model_dict[name_of_enc_models[i]].fc3_enc_B3
...
#################################### Approach No.2: centralized Matrix with Encryption ####################################

ExportToFile= 'Appr2_Output'+dataset_name
...
for i in range(numEpoch):
    ...
    fc1_mean_weight, fc1_mean_bias, fc2_mean_weight, fc2_mean_bias, fc3_mean_weight, fc3_mean_bias, total_size_Enc_W_B = Server_get_averaged_weights(matrix_dict_, number_of_samples)
